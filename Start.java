					...
					switch(choice4)
					{
						...
						case 2:
						{
							...
							if(m.searchShop(sId2) != null)
							{
								...
								if(m.searchShop(sId2).searchProduct(pId5) !=null)
								{
									System.out.print("Enter Amount to Sell: ");
									int am1 = sc.nextInt();
									
									if(m.searchShop(sId2).searchProduct(pId5).sellQuantity(am1))
									{
										System.out.println("Sold Successfully");
										frwd.writeInFile("Product with ID "+pId5+" Sold for the shop with ID "+sId2);
									}
									else
									{
						...
						{
							System.out.println("---------------------------------");
							System.out.println("You Choose See ADD Sell History");
							System.out.println("---------------------------------");
